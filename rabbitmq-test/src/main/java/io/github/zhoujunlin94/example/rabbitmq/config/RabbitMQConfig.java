package io.github.zhoujunlin94.example.rabbitmq.config;
...
public class RabbitMQConfig {
    ...
    public static class DirectExchangeDemoConfiguration {
        ...
        // 创建 Direct Exchange  完全匹配 binding key 与 routing key
        @Bean
    ...
    /**
     * Headers Exchange 示例的配置类  性能低  一般不使用
     */
