package io.github.zhoujunlin94.example.seata.product.repository.db.handler.product;

import io.github.zhoujunlin94.example.seata.product.config.ProductMybatisConfig;
import io.github.zhoujunlin94.example.seata.product.repository.db.entity.product.Product;
import io.github.zhoujunlin94.example.seata.product.repository.db.mapper.product.ProductMapper;
...
public class ProductHandler extends TKHandler<ProductMapper, Product> {
    ...
    // 开启新事务
    @Transactional(transactionManager = ProductMybatisConfig.TRANSACTION_MANAGER, rollbackFor = Exception.class)
