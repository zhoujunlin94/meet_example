package io.github.zhoujunlin94.example.seata.product.config;
 ...
 **/
@Configuration
@MapperScan(basePackages = "io.github.zhoujunlin94.example.seata.product.repository.db.mapper.product", annotationClass = Mapper.class,
...
public class ProductMybatisConfig extends AbstractMybatisConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE = "io.github.zhoujunlin94.example.seata.product.repository.db.entity.product";
