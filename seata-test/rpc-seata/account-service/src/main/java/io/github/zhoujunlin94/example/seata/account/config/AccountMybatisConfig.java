package io.github.zhoujunlin94.example.seata.account.config;
 ...
 **/
@Configuration
@MapperScan(basePackages = "io.github.zhoujunlin94.example.seata.account.repository.db.mapper.account", annotationClass = Mapper.class,
...
public class AccountMybatisConfig extends AbstractMybatisConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE = "io.github.zhoujunlin94.example.seata.account.repository.db.entity.account";
