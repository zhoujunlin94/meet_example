package io.github.zhoujunlin94.example.seata.order.config;
 ...
 **/
@Configuration
@MapperScan(basePackages = "io.github.zhoujunlin94.example.seata.order.repository.db.mapper.order", annotationClass = Mapper.class,
...
public class OrderMybatisConfig extends AbstractMybatisConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE = "io.github.zhoujunlin94.example.seata.order.repository.db.entity.order";
