package io.github.zhoujunlin94.example.seata.ds.repository.db.handler.account;

import cn.hutool.core.convert.Convert;
import io.github.zhoujunlin94.example.seata.ds.config.AccountMybatisConfig;
import io.github.zhoujunlin94.example.seata.ds.repository.db.entity.account.Account;
import io.github.zhoujunlin94.example.seata.ds.repository.db.mapper.account.AccountMapper;
...
public class AccountHandler extends TKHandler<AccountMapper, Account> {
    ...
    // 开启新事物
    @Transactional(transactionManager = AccountMybatisConfig.TRANSACTION_MANAGER, propagation = Propagation.REQUIRES_NEW, rollbackFor = Exception.class)
