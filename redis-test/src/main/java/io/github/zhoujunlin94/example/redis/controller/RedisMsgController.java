package io.github.zhoujunlin94.example.redis.controller;
...
public class RedisMsgController {
    ...
    public String provider() {
        ...
        //需要立即被消费
        redisDelayQueue.delay("defaultQueueHandler", "provider demo msg1", 0, TimeUnit.SECONDS);
        //延迟5秒消费
        redisDelayQueue.delay("defaultQueueHandler", "provider demo msg2", 5, TimeUnit.SECONDS);
        redisDelayQueue.delay("defaultQueueHandler", "provider demo msg3", 30, TimeUnit.SECONDS);
        return "success";
    }
    ...
    public String publishMsg() {
        ...
        RedisHelper.publishMsg("defaultPubSubHandler", taskItem.toString());
